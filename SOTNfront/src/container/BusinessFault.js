...
import ChartExample from '../component/pub/legend/ChartExample';
...
class BusinessFault extends Component {
  ...
  getFistData = () => {
    ...
    getAxios('api/alarms/stats/num/severity', {}, data => {
      this.setState({
  ...
  // 请求右侧专线列表
  getListData = (currentPage, pageSize, nameLike) => {
    getAxios(
      'api/leased_lines',
      {
        currentPage,
            ...
            <div className="left1">
              ...
              <div style={{ height: '100%' }}>
                <Iframe
                  ...
                  url={`${baseStaticUrl}gis/gis3/businessFault/china.html`}
