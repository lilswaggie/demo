...
import SelectAppPage from './container/SelectAppPage';
import LineCustomerModal from './component/pub/modal/LineCustomerModal';
        ...
        try {
          ...
          const requestConfig = {
            ...
            successCallback: () =>
              this.props.dispatch(
                replace('/app')
                // replace(!this.props.app.type ? '/app' : '/main/home')
              ),
  ...
  render() {
    ...
    return (
      <div className="app" onClick={this.onClick}>
        ...
        <Route path="/app" component={SelectAppPage} />
