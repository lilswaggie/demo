...
export const multiplexSectionColumns = [
  ...
  },
  {
    ...
    render: (text, record) => (
      <div>
        <span title={`${record.bandwidthUsed}/${record.bandwidthConf}`}>
          <span className="color-first">{`${record.bandwidthUsed}`}</span>/
          <span className="color-second">{`${record.bandwidthConf}`}</span>
          {/* {`${record.bandwidthUsed}/${record.bandwidthConf}`} */}
        </span>
      </div>
    ),
  ...
  },
  {
    ...
    render: (text, record) => (
      <div>
        <span
          title={`${record.bandwidthUsed}/${record.bandwidthConf}/${
            record.waveConfNum
          }`}
        >
          <span className="color-first">{`${record.bandwidthUsed}`}</span>/
          <span className="color-second">{`${record.bandwidthConf}`}</span>/
          <span>{`${record.waveConfNum}`}</span>
          {/* {`${record.bandwidthUsed}/${record.bandwidthConf}/${record.waveConfNum}`} */}
        </span>
      </div>
    ),
...
//     {name: '省际', value: 82},
//     {name: '省内', value: 2094},
//     {name: '本地汇聚', value: 12000},
//     {name: '本地骨干', value: 8023},
//     {name: '本地汇聚', value: 12204},
//     {name: '本地接入', value: 45906},
//     {name: '其他', value: 4506},
// ];
// const cardArr = [
//     {name: '板卡型号1', value: 82},
//     {name: '板卡型号2', value: 2094},
//     {name: '板卡型号3', value: 12000},
//     {name: '板卡型号4', value: 8023},
//     {name: '板卡型号5', value: 12204},
//     {name: '板卡型号6', value: 45906},
// ];
