...
class BarEchart extends React.Component {
  ...
  componentWillReceiveProps(coming) {
    if (coming && coming.barValue &&
      coming.barValue !== this.props.barValue) {
      const option = getOption(coming.barValue, coming.barAxis, coming.itemName, coming.needPercent, coming.yName);
  ...
  mountMap(node) {
    const option = getOption(this.props.barValue, this.props.barAxis, this.props.itemName, this.props.needPercent, this.props.yName);
  ...
  render() {
    return (
      <div className="network-wrapper">
        <div className="network" ref={(pie) => { this.node = pie; }} />
      </div>
    );
  }
}
